      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden min-h-[500px] flex flex-col">
            ...
            {!sacraments.confession.pin && !showSetupPin ? (
                ...
                <textarea
                    ...
                    className="w-full flex-1 p-4 bg-yellow-50/50 rounded-xl border border-yellow-100 resize-none focus:ring-2 focus:ring-yellow-200 focus:outline-none mb-4 text-slate-800 leading-relaxed min-h-[300px]"
                    autoFocus
                />
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex items-center justify-between">
                <div>
                <p className="font-bold text-slate-700">تاريخ آخر اعتراف</p>
            ...
            {/* Tips/Quotes about Confession */}
            <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                <h4 className="font-bold text-blue-800 mb-2">عن سر الاعتراف</h4>
                <p className="text-sm text-blue-700 leading-relaxed">
                    "إن اعترفنا بخطايانا فهو أمين وعادل، حتى يغفر لنا خطايانا ويطهرنا من كل إثم." (1 يوحنا 1: 9)
                    <br/><br/>
                    اجعل جلسة الاعتراف دورية وثابتة للحفاظ على نقاوة القلب والاستعداد الدائم للتناول.
                </p>
            </div>
