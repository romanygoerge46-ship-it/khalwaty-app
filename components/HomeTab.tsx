...
export default function HomeTab({ state, onUpdateLog, onUpdateBible, onUpdateMessage, onAddPoints, onAddFeeling, onEncourage }: Props) {
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      {/* 1. Header (Redesigned) */}
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-8 rounded-b-[2.5rem] -mt-4 shadow-xl shadow-blue-200/50 text-white relative overflow-hidden">
         ...
         <div className="relative z-10 flex justify-between items-start">
           ...
           <div className="flex flex-col items-center cursor-pointer group" onClick={() => setShowCrownHistory(true)}>
             <div className={`w-14 h-14 rounded-2xl border-2 flex items-center justify-center relative transition-all duration-700 ${isWreathLit ? 'border-amber-300 bg-amber-400/20 shadow-[0_0_30px_rgba(251,191,36,0.6)]' : 'border-white/20 bg-white/10 group-hover:bg-white/20'}`}>
                <Flame className={`w-6 h-6 ${isWreathLit ? 'text-amber-300 fill-amber-300 animate-pulse' : 'text-blue-100'}`} />
             </div>
             {/* Crown Day Label */}
         ...
         {/* Top Stats Row */}
         <div className="mt-8 flex justify-between bg-white/10 rounded-2xl p-4 backdrop-blur-md border border-white/20 shadow-inner">
      ...
      <div className="px-5 space-y-6 -mt-4 relative z-20">
        ...
        {/* Feelings Reminder */}
        <div className="bg-white rounded-2xl shadow-lg shadow-slate-200/50 border border-slate-50 p-4 flex items-center justify-between">
           {todaysFeeling ? (
             <div className="flex items-center gap-3">
                <div className="text-3xl bg-blue-50 w-12 h-12 flex items-center justify-center rounded-full">
                    ...
                    {/* Simplified emoji logic, realistically would map ID to Emoji */}
                </div>
                <div>
        ...
        {fastingAlert && (
          <div className="bg-purple-50 border border-purple-100 text-purple-900 p-4 rounded-2xl flex items-center gap-3 shadow-sm">
        ...
        {/* 2. Daily Verse */}
        <div className="bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/40 overflow-hidden group hover:border-amber-200 transition-all duration-300">
           ...
           <div className="bg-slate-50 p-3 flex items-center justify-between border-t border-slate-100">
              ...
              >
                <Copy className="w-4 h-4" /> نسخ الآية
              </button>
              ...
              >
                ...
                {log.dailyVerseRead ? "تمت القراءة" : "إتمام القراءة"}
              </button>
           </div>
        </div>
           
        {/* New Abayeyat Section */}
        <div className="bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/40 overflow-hidden group hover:border-blue-200 transition-all duration-300">
             ...
             <div className="bg-slate-50 p-3 flex items-center justify-between border-t border-slate-100">
                ...
                >
                    <Copy className="w-4 h-4" /> نسخ القول
                </button>
                ...
                >
                    ...
                    {log.dailyAbayaRead ? "تمت القراءة" : "إتمام القراءة"}
                </button>
             </div>
        </div>

        {/* 3. Jesus Prayer (Updated Text) */}
        <div className="p-6 bg-white rounded-3xl border border-slate-100 shadow-lg shadow-slate-100 text-center">
             ...
             <p className="text-xs text-slate-400 font-bold mb-6">رددها ٣ مرات بقلبك ولسانك</p>
        ...
        {/* 4. Prayers (Agpeya) - Simple Toggle */}
        ...
        {/* 6. Bible Section (Incremental/Chunks) */}
        <div className="bg-white p-6 rounded-3xl shadow-lg shadow-slate-100 border border-slate-100">
