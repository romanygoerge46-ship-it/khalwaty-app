        ...
        <div className="lg:col-span-2 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <button 
                    ...
                    className="w-full bg-white p-5 flex items-center justify-between rounded-2xl border border-slate-100 shadow-sm hover:border-purple-200 hover:shadow-md transition-all group"
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-right">
                            <p className="font-bold text-slate-800 text-base">إعادة تعيين رمز الاعتراف</p>
                            <p className="text-xs text-slate-400 mt-1">سيتم مسح الرمز الحالي</p>
                        </div>
                    </div>
                ...
                {/* Subscription */}
                <div className="w-full bg-white p-5 flex items-center justify-between rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-4">
                        <div className="bg-orange-100 p-3 rounded-xl text-orange-600">
                            <Shield className="w-6 h-6" />
                        </div>
                        <div className="text-right">
                            <p className="font-bold text-slate-800 text-base">حالة الاشتراك</p>
                            <p className="text-xs text-slate-400 mt-1">
                                {state.adsRemoved ? "نسخة خالية من الإعلانات" : "النسخة المجانية"}
                            </p>
                        </div>
                    </div>
                    {state.adsRemoved && <Heart className="w-6 h-6 text-red-500 fill-red-500" />}
                </div>
            </div>
            ...
            <p className="text-center text-xs text-slate-300 pt-4 font-bold">الإصدار 1.1.0 (Web) - خلوتي</p>
        </div>
      </div>
